...
class ProblemaRuedas:
    def __init__(self):
        # Matriz de precios: filas=empresas(1-4), columnas=tipos(T,H,V,W)
        self.precios = {
    ...
    def heuristica_admisible(self, estado):
        ...
        Esta heurística es admisible porque subestima el costo real.
        """
        ...
        for tipo in tipos_pendientes:
            ...
            # Tomar el mínimo precio de este tipo entre todas las empresas disponibles
    ...
    def generar_hijos(self, estado_actual):
        ...
        # Para el siguiente tipo a asignar
    ...
    def buscar_a_estrella(self):
        ...
        while not solucionado and len(nodos_frontera) > 0:
            ...
            nodos_frontera.sort(key=lambda x: x.get_coste_total())
            ...
            for hijo_estado in hijos_estados:
                # Calcular costo g(n) para el hijo
                ...
                if hijo_nodo.en_lista(nodos_frontera):
                    for n in nodos_frontera:
                        if n.igual(hijo_nodo) and n.get_coste_total() > hijo_nodo.get_coste_total():
    ...
    def obtener_solucion(self):
        ...
        # Nombres de empresas para mostrar
        nombres_empresas = ['Empresa 1', 'Empresa 2', 'Empresa 3', 'Empresa 4']
        ...
        for estado in camino:
            ...
            for tipo, empresa in estado.items():
                asignacion_legible[tipo] = nombres_empresas[empresa]
        ...
        return {
            ...
            'detalle': self._obtener_detalle(nodo_solucion.get_datos(), nombres_empresas)
        }
    
    def _obtener_detalle(self, estado, nombres_empresas):
        ...
        for tipo, empresa in estado.items():
            ...
            detalle.append({
                'tipo': tipo,
                'empresa': nombres_empresas[empresa],
                'costo': costo
            })
        return detalle